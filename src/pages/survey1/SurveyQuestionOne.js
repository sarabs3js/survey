...
const QuestionOne = ({ next }) => {
  ...
  return (
    <div className="question1">
      <h1 className="header">What's your favourite icecream?</h1>
      <div style={{ display: "flex" }}></div>

      {showResults && (
        <div style={{ display: "flex" }}>
          {data.map((d) => (
            <Bar text={d.title} result={d.value} color={d.color} />
          ))}
        </div>
      )}
        ...
        <div className="radiobutton">
          <div className="seperate">
            <button onClick={() => updatedResult("vanilla", 1)}>
              <img className="img" src={vanilla} alt="" />
              <br />
              Vanilla
            </button>
          </div>
          <div className="seperate">
            <button onClick={() => updatedResult("chocolate", 2)}>
              {" "}
              <img className="img" src={choclate} alt="" />
              <br />
              Choclate
            </button>
          </div>
          <div className="seperate">
            <button onClick={() => updatedResult("butter", 3)}>
              <img className="img" src={butter} alt="" />
              <br />
              Butter Scotch
            </button>
          </div>
